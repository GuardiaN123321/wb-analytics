...
$ch_1 = curl_init('https://search.wb.ru/exactmatch/ru/common/v9/search?ab_testing=false&appType=128&curr=rub&dest='.$data3.'&page=1&query='.$data.'&resultset=catalog&sort=popular&spp=30&suppressSpellcheck=false');
$ch_2 = curl_init('https://search.wb.ru/exactmatch/ru/common/v9/search?ab_testing=false&appType=128&curr=rub&dest='.$data3.'&page=2&query='.$data.'&resultset=catalog&sort=popular&spp=30&suppressSpellcheck=false');
$ch_3 = curl_init('https://search.wb.ru/exactmatch/ru/common/v9/search?ab_testing=false&appType=128&curr=rub&dest='.$data3.'&page=3&query='.$data.'&resultset=catalog&sort=popular&spp=30&suppressSpellcheck=false');
$ch_4 = curl_init('https://search.wb.ru/exactmatch/ru/common/v9/search?ab_testing=false&appType=128&curr=rub&dest='.$data3.'&page=4&query='.$data.'&resultset=catalog&sort=popular&spp=30&suppressSpellcheck=false');
$ch_5 = curl_init('https://search.wb.ru/exactmatch/ru/common/v9/search?ab_testing=false&appType=128&curr=rub&dest='.$data3.'&page=5&query='.$data.'&resultset=catalog&sort=popular&spp=30&suppressSpellcheck=false');
